...
.active {
  ...
  <li><a href="#about">About</a></li>
    ...
    <h3 style ="color:red;font-weight: bold;text-align:center;padding:0px;"><br><br> The SI for Engineering Survering Software is meteric (m)  <br><br>
  <!--  Unit for Reinforcement bars  MILLIMETER<br><br>
   Unit for all other calculation are in METER<br><br>   --></style>
<span class="btn-mmain"><a href ="index.php">Start </a> </span><br><br><br>
<span class="btn-mmain"><a href ="index1.php">Start with simple theme </a> </span><br><br><br>
      <br><br></h3><br>
